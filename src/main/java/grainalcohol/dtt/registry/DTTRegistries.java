...
public class DTTRegistries {
    ...
    public static final RegistryKey<Registry<HintMessage>> HINT_MESSAGE_REGISTRYKEY = RegistryKey.ofRegistry(DTTMod.id("hint_message"));
    ...
    static {
        ...
        HINT_MESSAGE_REGISTRY = FabricRegistryBuilder.createSimple(HINT_MESSAGE_REGISTRYKEY).buildAndRegister();
    }
}
